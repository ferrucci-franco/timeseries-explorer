...
const i18n = {
    ...
    translations: {
        en: {
            ...
            dropStateX1:     '① Drop state variable x₁ (or x[1])',
            dropStateX2:     '② Drop state variable x₂ (or auto-detected)',
            dropStateX2Short:'② Drop state variable x₂',
            dropStateX3:     '③ Drop x₃ for 3D (or drop to configure)',
            ...
            helpSec5Body: 'The <b>▶x</b> mode animates the time evolution of state-space variables.<ul><li>Drop a variable (e.g. <code>x[1]</code>) onto a panel set to <b>▶x</b> mode. The app automatically detects vector siblings (<code>x[2]</code>, <code>x[3]</code>) and their derivatives (<code>der(…)</code>).</li><li><b>2D</b> — two state variables are plotted as a phase portrait with an animated marker and optional arrows for the state vector (orange) and its derivative (purple).</li><li><b>3D</b> — three state variables produce an animated 3D trajectory.</li><li>Use the <b>Trace</b>, <b>x⃗</b>, <b>dx/dt</b>, and <b>Norm</b> toggles to show/hide the trajectory trail, state arrow, derivative arrow, and normalised derivative respectively.</li><li><b>Dynamic zoom</b> adjusts the axis range to follow the current position during animation.</li><li>The scrubber, play/pause, and speed controls let you navigate the simulation timeline.</li></ul>'
        },
        ...
        fr: {
            ...
            dropStateX1:     '① Déposez la variable d\'état x₁ (ou x[1])',
            dropStateX2:     '② Déposez la variable d\'état x₂ (ou détectée automatiquement)',
            dropStateX2Short:'② Déposez la variable d\'état x₂',
            dropStateX3:     '③ Déposez x₃ pour la 3D (ou déposez pour configurer)',
            ...
            helpSec5Body: 'Le mode <b>▶x</b> anime l\'évolution temporelle des variables d\'état.<ul><li>Déposez une variable (par ex. <code>x[1]</code>) sur un panneau en mode <b>▶x</b>. L\'application détecte automatiquement les variables voisines (<code>x[2]</code>, <code>x[3]</code>) et leurs dérivées (<code>der(…)</code>).</li><li><b>2D</b> — deux variables d\'état sont tracées en portrait de phase avec un marqueur animé et des flèches optionnelles pour le vecteur d\'état (orange) et sa dérivée (violet).</li><li><b>3D</b> — trois variables d\'état produisent une trajectoire 3D animée.</li><li>Utilisez les boutons <b>Trace</b>, <b>x⃗</b>, <b>dx/dt</b> et <b>Norm</b> pour afficher/masquer la trace, la flèche d\'état, la flèche de dérivée et la dérivée normalisée.</li><li><b>Zoom dynamique</b> ajuste la plage des axes pour suivre la position actuelle pendant l\'animation.</li><li>Le curseur, les boutons lecture/pause et les contrôles de vitesse permettent de naviguer dans la chronologie de la simulation.</li></ul>'
        },
        ...
        es: {
            ...
            dropStateX1:     '① Arrastra la variable de estado x₁ (o x[1])',
            dropStateX2:     '② Arrastra la variable de estado x₂ (o detectada automáticamente)',
            dropStateX2Short:'② Arrastra la variable de estado x₂',
            dropStateX3:     '③ Arrastra x₃ para 3D (o arrastra para configurar)',
            ...
            helpSec5Body: 'El modo <b>▶x</b> anima la evolución temporal de las variables de estado.<ul><li>Arrastre una variable (ej. <code>x[1]</code>) a un panel en modo <b>▶x</b>. La aplicación detecta automáticamente las variables vecinas (<code>x[2]</code>, <code>x[3]</code>) y sus derivadas (<code>der(…)</code>).</li><li><b>2D</b> — dos variables de estado se representan como retrato de fase con un marcador animado y flechas opcionales para el vector de estado (naranja) y su derivada (púrpura).</li><li><b>3D</b> — tres variables de estado producen una trayectoria 3D animada.</li><li>Use los controles <b>Trace</b>, <b>x⃗</b>, <b>dx/dt</b> y <b>Norm</b> para mostrar/ocultar la traza, la flecha de estado, la flecha de derivada y la derivada normalizada.</li><li><b>Zoom dinámico</b> ajusta el rango de los ejes para seguir la posición actual durante la animación.</li><li>El control deslizante, los botones de reproducción/pausa y los controles de velocidad permiten navegar por la línea temporal de la simulación.</li></ul>'
        },
        ...
        it: {
            ...
            dropStateX1:     '① Trascina la variabile di stato x₁ (o x[1])',
            dropStateX2:     '② Trascina la variabile di stato x₂ (o rilevata automaticamente)',
            dropStateX2Short:'② Trascina la variabile di stato x₂',
            dropStateX3:     '③ Trascina x₃ per 3D (o trascina per configurare)',
            ...
            helpSec5Body: 'La modalità <b>▶x</b> anima l\'evoluzione temporale delle variabili di stato.<ul><li>Trascinare una variabile (es. <code>x[1]</code>) su un pannello in modalità <b>▶x</b>. L\'applicazione rileva automaticamente le variabili vicine (<code>x[2]</code>, <code>x[3]</code>) e le loro derivate (<code>der(…)</code>).</li><li><b>2D</b> — due variabili di stato vengono tracciate come ritratto di fase con un marcatore animato e frecce opzionali per il vettore di stato (arancione) e la sua derivata (viola).</li><li><b>3D</b> — tre variabili di stato producono una traiettoria 3D animata.</li><li>Usare i controlli <b>Trace</b>, <b>x⃗</b>, <b>dx/dt</b> e <b>Norm</b> per mostrare/nascondere la traccia, la freccia di stato, la freccia della derivata e la derivata normalizzata.</li><li><b>Zoom dinamico</b> regola l\'intervallo degli assi per seguire la posizione corrente durante l\'animazione.</li><li>Il cursore, i pulsanti play/pausa e i controlli di velocità consentono di navigare nella cronologia della simulazione.</li></ul>'
        }
    },
